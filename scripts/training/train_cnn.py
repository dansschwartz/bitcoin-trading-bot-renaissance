"""
Train the simple CNN model on historical OHLCV data.

Uses the TrainedCNN architecture from ml_model_loader (83-feature input,
4 conv layers, global avg pool, classifier head).

Usage:
    python -m scripts.training.train_cnn
    python -m scripts.training.train_cnn --epochs 100 --lr 5e-4
"""
...
from ml.ml_model_loader import TrainedCNN
...
SAVE_PATH = os.path.join(PROJECT_ROOT, "models", "trained", "best_cnn_model.pth")
